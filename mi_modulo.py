...
#Diagnostico
        'elegible': fields.selection([('Elegible','Elegible'),('Elegible con Limitaciones','Elegible con Limitaciones'),('No Elegible','No Elegible')],'elegible',size=25 ,  help='Forma Almacenatmiento'),
...
#El traajador cumplio con
        'referenciamedica': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'cumplioconcon': fields.text('Otros',  help='Resultados Examen Complementario'),
        #El traajador debe cumplir con
        'eva_esp': fields.selection([('si','si'),('no','no')],'Evaluacion por Especialistas', help='Forma Almacenatmiento'),
        'tratamientomedico': fields.selection([('si','si'),('no','no')],'Tratamiento Medico', help='Forma Almacenatmiento'),
        'eva_med_ocu': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'reevalucacion': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'estudios_compl': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'reposo': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
#sus actuales condiciones de salud hacen  necesario
	'bidepe': fields.selection([('si','si'),('no','no')],'Evaluacion por Especialistas', help='Forma Almacenatmiento'),
        'obj_pesados': fields.selection([('si','si'),('no','no')],'Tratamiento Medico', help='Forma Almacenatmiento'),
        'operar_montacargas': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'evitar_sustanciasquimicas': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'evi_trab_altura': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'evi_ruido': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),


        'observaciones': fields.text('Observaciones',  help='Resultados Examen Complementario'),


        #
        #postvacacional
         #Edo General
        'resultadosexamencomplementario3': fields.text('Resultados Examen Complementario',  help='Resultados Examen Complementario'),
        'peso3': fields.char('Peso',size=25 ,  help='Peso Pre-Vacacional'),
        'talla3': fields.char('Talla',size=12 ,  help='Talla Pre-Vacacional'),
        'ta3': fields.char('T.A.',size=15 ,  help='T.A.  Pre-Vacacional'),
        'fr3': fields.char('FR',size=12 ,  help='FR Pre-Vacacional'),
        'fc3': fields.char('FC',size=15 ,  help='FC Pre-Vacacional'),
        'condiciondespues3': fields.selection([('Buenas Condiciones','Buenas Condiciones'),('Regulares Condiciones','Regulares Condiciones'),('Malas Condiciones','Malas Condiciones')],'Condiciones Fisicas', help='Condiciones antes de las vaciones del Paciente'),
#El traajador cumplio con
        'referenciamedica3': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'cumplioconcon3': fields.text('Otros',  help='Resultados Examen Complementario'),
        #El traajador debe cumplir con
        'eva_esp3': fields.selection([('si','si'),('no','no')],'Evaluacion por Especialistas', help='Forma Almacenatmiento'),
        'tratamientomedico3': fields.selection([('si','si'),('no','no')],'Tratamiento Medico', help='Forma Almacenatmiento'),
        'eva_med_ocu3': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'reevalucacion3': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'estudios_compl3': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'reposo3': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
#sus actuales condiciones de salud hacen  necesario
	'bidepe3': fields.selection([('si','si'),('no','no')],'Evaluacion por Especialistas', help='Forma Almacenatmiento'),
        'obj_pesados3': fields.selection([('si','si'),('no','no')],'Tratamiento Medico', help='Forma Almacenatmiento'),
        'operar_montacargas3': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'evitar_sustanciasquimicas3': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'evi_trab_altura3': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'evi_ruido3': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),


        'observaciones3': fields.text('Observaciones',  help='Resultados Examen Complementario'),
 ...
 #Edo General
        'resultadosexamencomplementario4': fields.text('Resultados Examen Complementario',  help='Resultados Examen Complementario'),
        'peso4': fields.char('Peso',size=25 ,  help='Peso Pre-Vacacional'),
        'talla4': fields.char('Talla',size=12 ,  help='Talla Pre-Vacacional'),
        'ta4': fields.char('T.A.',size=15 ,  help='T.A.  Pre-Vacacional'),
        'fr4': fields.char('FR',size=12 ,  help='FR Pre-Vacacional'),
        'fc4': fields.char('FC',size=15 ,  help='FC Pre-Vacacional'),
        'condiciondespues4': fields.selection([('Buenas Condiciones','Buenas Condiciones'),('Regulares Condiciones','Regulares Condiciones'),('Malas Condiciones','Malas Condiciones')],'Condiciones Fisicas', help='Condiciones antes de las vaciones del Paciente'),
#El traajador cumplio con
        'referenciamedica4': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'cumplioconcon4': fields.text('Otros',  help='Resultados Examen Complementario'),
        #El traajador debe cumplir con
        'eva_esp4': fields.selection([('si','si'),('no','no')],'Evaluacion por Especialistas', help='Forma Almacenatmiento'),
        'tratamientomedico4': fields.selection([('si','si'),('no','no')],'Tratamiento Medico', help='Forma Almacenatmiento'),
        'eva_med_ocu4': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'reevalucacion4': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'estudios_compl4': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'reposo4': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
#sus actuales condiciones de salud hacen  necesario
	'bidepe4': fields.selection([('si','si'),('no','no')],'Evaluacion por Especialistas', help='Forma Almacenatmiento'),
        'obj_pesados4': fields.selection([('si','si'),('no','no')],'Tratamiento Medico', help='Forma Almacenatmiento'),
        'operar_montacargas4': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'evitar_sustanciasquimicas4': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'evi_trab_altura4': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),
        'evi_ruido4': fields.selection([('si','si'),('no','no')],'Referencia Medica', help='Forma Almacenatmiento'),


        'observaciones4': fields.text('Observaciones',  help='Resultados Examen Complementario'),
